...
Matrix Matrix::operator + ( const Matrix &m ) const  // operator +
{
...
int main()
{
	...
	if ( m1 == m2 ) cout << "Matrix are Equal" << endl;
	...
	Matrix m5 = m2 + m4;  // operator +
	m5.printMatrix();
	cout << endl << endl;
	
	Matrix m6 = m2 - m4;  // operator -
	m6.printMatrix();
	cout << endl << endl;
	
	Matrix m7 = m5 * m2;  // operator *
	m7.printMatrix();
	cout << endl << endl;	
